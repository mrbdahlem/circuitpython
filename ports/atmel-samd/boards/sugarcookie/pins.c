...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_CS), MP_ROM_PTR(&pin_PA04) },
...
/*
    ...
    { MP_ROM_QSTR(MP_QSTR_CS), MP_ROM_PTR(&pin_PA18) },
*/
    ...
    { MP_ROM_QSTR(MP_QSTR_D14), MP_ROM_PTR(&pin_PA01) },
    { MP_ROM_QSTR(MP_QSTR_D15), MP_ROM_PTR(&pin_PA00) },
